...
function analisys (NomeCliente, ValorCompra, PrimeiraCompra, PagarAVista) {
    if(PrimeiraCompra==="Sim"){
        if(PagarAVista==="Sim"){
            if(ValorCompra > 1000){
                console.log(`${NomeCliente} tem 30% de desconto! A compra ficará de R$${ValorCompra.toFixed(2)} para R$${(ValorCompra*0.7).toFixed(2)}. Agradecemos por comprar com a gente!`)
            } else if(ValorCompra < 500){
                console.log(`${NomeCliente} tem 20% de desconto! A compra ficará de R$${ValorCompra.toFixed(2)} para R$${(ValorCompra*0.8).toFixed(2)}. Agradecemos por comprar com a gente!`)
            } else {
                console.log(`${NomeCliente} tem 25% de desconto! A compra ficará de R$${ValorCompra.toFixed(2)} para R$${(ValorCompra*0.75).toFixed(2)}. Agradecemos por comprar com a gente!`)
            }
        }else{
            if(ValorCompra > 1000){
                console.log(`${NomeCliente} tem 20% de desconto! A compra ficará de R$${ValorCompra.toFixed(2)} para R$${(ValorCompra*0.8).toFixed(2)}. Agradecemos por comprar com a gente!`)
            } else if(ValorCompra < 500){
                console.log(`${NomeCliente} tem 10% de desconto! A compra ficará de R$${ValorCompra.toFixed(2)} para R$${(ValorCompra*0.9).toFixed(2)}. Agradecemos por comprar com a gente!`)
            } else {
                console.log(`${NomeCliente} tem 15% de desconto! A compra ficará de R$${ValorCompra.toFixed(2)} para R$${(ValorCompra*0.85).toFixed(2)}. Agradecemos por comprar com a gente!`)
            }
        }
    } else {
        if(PagarAVista==="Sim"){
            ...
            if(ValorCompra > 1000){
                ...
                console.log(`Me desculpe ${NomeCliente}, você não tem desconto. A compora ficou R$${ValorCompra.toFixed(2)} e receba esse cupom de desconto de ${(Math.random()*(20-10)+10).toFixed(0)}% para usar na próxima compra. Agradecemos por comprar com a gente!`)
            } else {
                console.log(`${NomeCliente} tem 5% de desconto! A compra ficará de R$${ValorCompra.toFixed(2)} para R$${(ValorCompra*0.7).toFixed(2)}. Agradecemos por comprar com a gente!`)
            }
        }
    }     
}
